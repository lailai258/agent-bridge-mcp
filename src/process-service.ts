...
import { parseAntigravityOutput, parseClaudeOutput, parseCodexOutput, parseForgeOutput, parseOpenCodeOutput, PeekEventExtractor } from './parsers.js';
import {
  appendPeekEvents,
...
export type AgentType = 'claude' | 'codex' | 'forge' | 'opencode' | 'antigravity';
